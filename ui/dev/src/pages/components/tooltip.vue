    ...
    <div class="q-layout-padding">
      ...
      <div class="q-gutter-sm">
        ...
        <q-btn color="indigo" label="External Model">
          <q-tooltip :modelValue="toggleOn" :no-parent-event="true" anchor="top middle" self="bottom middle" :offset="[18, 18]" transition-show="flip-right" transition-hide="flip-left">
            <strong>Tooltip</strong> on <em>top</em> (<q-icon name="keyboard_arrow_up" />)
          </q-tooltip>
        </q-btn>
      </div>
