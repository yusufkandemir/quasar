  ...
  <div class="column no-wrap" style="height: 100vh" :class="dark ? 'bg-black text-white' : ''">
    ...
    <div class="col scroll q-pl-md q-pr-xl q-gutter-y-lg">
      ...
      <div class="row justify-around">
        <q-range :vertical="vertical" :dark="dark" :dense="dense" @change="onChange" @update:modelValue="onModelUpdate" v-model="standalone" :min="0" :max="50" />
        <q-range :vertical="vertical" :dark="dark" :dense="dense" @change="val => { standalone = val; onChange(val); }" @update:modelValue="onModelUpdate" :modelValue="standalone" :min="0" :max="50" label :left-label-value="labelLeftValue(standalone.min)" :right-label-value="labelRightValue(standalone.max)" />
      ...
      <div class="row justify-around">
        <q-range :vertical="vertical" :dark="dark" :dense="dense" @change="onChange" @update:modelValue="onModelUpdate" v-model="range" :min="0" :max="100" label :left-label-value="labelLeftValue(range.min)" :right-label-value="labelRightValue(range.max)" drag-range />
        <q-range :vertical="vertical" :dark="dark" :dense="dense" @change="val => { range = val; onChange(val); }" @update:modelValue="onModelUpdate" :modelValue="range" :min="0" :max="100" label :left-label-value="labelLeftValue(range.min)" :right-label-value="labelRightValue(range.max)" drag-range />
      </div>
      ...
      <div class="row justify-around">
        ...
        <q-range :vertical="vertical" :dark="dark" :dense="dense" :modelValue="onlyRange" @change="val => { onlyRange = val }" :min="0" :max="100" :step="5" drag-only-range label :left-label-value="labelLeftValue(onlyRange.min)" :right-label-value="labelRightValue(onlyRange.max)" />
      </div>
