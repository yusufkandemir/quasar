  ...
  <div>
    <div class="q-layout-padding">
      ...
      <div class="column q-gutter-md" style="font-size: 2rem; margin-top: 20px;">
        <q-rating v-model="ratingModel" max="3" @change="onChange" @update:modelValue="onModelUpdate" />
        <q-rating v-model="ratingModel" color="primary" max="5" icon="pets" @update:modelValue="onModelUpdate" />
      ...
      <div class="column q-gutter-md" style="font-size: 2rem; margin-top: 20px;">
        ...
        <q-rating v-model="halfModel" color="primary" max="5" icon="pets" @update:modelValue="onModelUpdate" icon-half="star_half" />
