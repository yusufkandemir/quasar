...
export default defineComponent({
  ...
  data () {
    ...
    const innerLocale = this.__getLocale()
    const viewModel = this.__getViewModel(innerMask, innerLocale)
    const year = viewModel.year
    const direction = this.$q.lang.rtl === true ? 'right' : 'left'
        ...
        years.push(
          h('div', {
            ...
            h(QBtn, {
              ...
              ...cache(this, 'yr#' + i, { onClick: () => { this.__setYear(i) } })
            })
          ])
        )
      }
