import { h, defineComponent, vShow, withDirectives } from 'vue'
...
export default defineComponent({
  ...
  emits: ['update:selected', 'update:expanded', 'after-show', 'after-hide', 'lazy-load'],
  ...
  methods: {
    ...
    __getNode (node) {
      ...
      return h('div', {
        key,
        class: ['q-tree__node relative-position', isParent === true ? 'q-tree__node--parent' : 'q-tree__node--child']
      }, [
        h('div', {
          class: {
            'q-tree__node-header relative-position row no-wrap items-center': true,
          ...
          h('div', { class: 'q-focus-helper', tabindex: -1, ref: `blurTarget_${meta.key}` }),
          ...
          h('div', {
            class: [
              ...
              meta.selected ? this.selectedColorClass : this.textColorClass
            ]
          }, [
            header
              ? header(slotScope)
